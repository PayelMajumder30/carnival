                                    ...
                                    <tr id="{{$item->id}}">
                                        ...
                                        <td class="text-center">
                                            <div class="custom-control custom-switch mt-1" data-toggle="tooltip" title="Toggle status">
                                                <input type="checkbox" class="custom-control-input" id="customSwitch{{$item->id}}" {{ ($item->status == 1) ? 'checked' : '' }} onchange="statusAllToggle('{{ route('admin.tag.status', $item->id) }}')">
